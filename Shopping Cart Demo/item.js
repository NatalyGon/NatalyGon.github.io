...
//funciton to get the ID of the item
function getID(arg)
{
    var counter = 0;
...
//funciton to add items to shopping cart
function add(arg)
{
...
function displayCart()
{
    ...
    else
    {
        ...
        for( var x = 0; x < sessionStorage.length; x++)
        {
            ...
            output += "<td><input type='button' class='btn btn-primary' value='Delete' onclick='remove(\"" + key + "\")'></td></tr>"; //get delete button and configure arg for remove funvtion
